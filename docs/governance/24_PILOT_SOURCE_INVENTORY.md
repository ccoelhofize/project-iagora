...
| `src-city-procurement-open-data` | [City public-procurement dataset from 2020 onward](https://opendata.clermont-ferrand.fr/explore/dataset/marches-publics-a-partir-de-2020-vcf/) and [API](https://opendata.clermont-ferrand.fr/api/explore/v2.1/catalog/datasets/marches-publics-a-partir-de-2020-vcf/records) | Available; source metadata modified 8 July 2026; exact eight-row service response preserved 30 July and one-row works-framework response preserved 1 August 2026 | Authoritative with limitation for the contract metadata and excluding-tax values the City publishes; relevant records cover a 2020 study, a 2021 citywide schoolyard works framework, and 2025-labelled design and user-assistance services | Licence Ouverte 2.0; exact 4,253-byte and 811-byte responses retained with acquisition events and SHA-256. Holder-grain values MUST be counted once per procurement identifier. The €2.6 million works-framework value is a 24-month maximum, not expenditure |
...
| `src-boamp-schoolyard-works-2022` | BOAMP [works competition `22-149017`](https://www.boamp.fr/pages/avis/?q=idweb:22-149017) and [rectification `22-157373`](https://www.boamp.fr/pages/avis/?q=idweb:22-157373) | Official competition published 8 November 2022 and rectified 28 November 2022 | Authoritative with limitation for the citywide schoolyard-works object, four-year duration, €1.6–4 million excluding-tax framework bounds, funding statement, and corrected internal reference `2022CF-TRX76` | Executable metadata, notice identifiers, 5,835-byte response size, and SHA-256 admitted; raw response not retained because the official catalog states no dataset licence. No award, purchase order, Respire link, or pilot-school allocation was located |
...
| Procurement | Candidate evidence records a €45,750 excluding-tax study notified in 2020, a 24-month citywide schoolyard works framework notified in 2021 with a published €2.6 million maximum, a separate four-year works-framework competition published in 2022 with €1.6–4 million bounds, and a two-lot 2025 design procedure awarded for €81,500 and €76,800 excluding tax | None directly names Respire. The works frameworks identify no purchase order or pilot school; their maxima are not spending and MUST NOT be added. No works record has been mapped to Nestor-Perret, Pierre-et-Marie-Curie, or Jean-Zay, and no competent completion record was found |
...
| --- | --- | --- | --- |
| P0 | Works procurement and competent acceptance for the three pilot cases | Citywide works frameworks were located for 2021 and 2022, but no purchase order, award trail, pilot-school allocation, or competent acceptance record was found | Search the 2021 framework orders and the award or orders under corrected reference `2022CF-TRX76`, then match only scope-bearing records to each school. Unrelated building, boiler, refectory, lift, painting, and energy-renovation contracts MUST remain excluded |
...
## Acquisition and quality update — 1 August 2026

- The City dataset reports procurement `20212105200`, notified on 25 May 2021, as a 24-month framework for road and landscaping works in Clermont-Ferrand schoolyards. Its €2.6 million excluding-tax amount is the maximum order value for the validity period under the dataset definition, not committed, invoiced, paid, or final expenditure.
- BOAMP notice `22-149017` records a separate four-year multi-awardee competition for road and landscaping works in City schoolyards, with a €1.6 million minimum and €4 million maximum excluding tax. Rectification `22-157373` corrects the internal reference to `2022CF-TRX76` and moves the response deadline to 9 December 2022.
- Neither works record names “Respire à la récré,” a pilot school, a purchase order, or competent completion. They therefore change the procurement state from “services only” to “candidate citywide works frameworks found, site attribution missing,” without changing `not_verifiable`.
- The 2021 and 2022 frameworks remain separate records. Their durations and financial bounds differ, and no reviewed source establishes that one supersedes or continues the other. Their maxima MUST NOT be added.
- Searches of the City register by Nestor-Perret, Pierre-et-Marie-Curie, and Jean-Zay returned unrelated building, refectory, boiler, painting, lift, and energy-renovation records. Those records remain excluded because their object does not establish schoolyard work.
- No BOAMP result linked to `22-149017`, no purchase order, no school-level payment, and no competent acceptance artifact was located in this acquisition. This is a recorded evidence gap, not evidence of non-delivery.

### Search log

| Search date | Public source and bounded query | Result | Evidence state |
| --- | --- | --- | --- |
| 2026-08-01 | City procurement API, identifier `20212105200` | One exact framework row retained with its acquisition event and fingerprint | Acquired open raw evidence; candidate citywide works framework only |
| 2026-08-01 | BOAMP, notice identifiers `22-149017` and `22-157373` | Competition and rectification metadata admitted; exact response fingerprint retained | Public official metadata; raw response unavailable in the repository pending rights review |
| 2026-08-01 | City procurement dataset, exact school-name searches for Nestor-Perret, Pierre-et-Marie-Curie, and Jean-Zay | Only records with unrelated work objects were returned and excluded | Searched evidence gap; not evidence that schoolyard work or delivery did not occur |
| 2026-08-01 | BOAMP result search linked to the 2022 competition and corrected reference `2022CF-TRX76` | No attributable result or award notice located | Searched evidence gap; not evidence that the framework was never awarded |

Purchase orders under the 2021 framework, award or order records under `2022CF-TRX76`, school-level financial records, competent acceptance artifacts, and before-and-after outcome measures remain in the prioritized queue and have not yet been exhaustively searched across all competent archives.
...
2. Adopted policy, programme authorization, programme expenditure, and limited site evidence are mapped. Candidate procurement records now cover study and design services plus citywide works frameworks without directly naming Respire. Purchase orders or contracts attributable to the pilot schools, transaction-level or school-level accounting, and competent completion records remain missing.

...
| `src-city-procurement-open-data` | [City public-procurement dataset from 2020 onward](https://opendata.clermont-ferrand.fr/explore/dataset/marches-publics-a-partir-de-2020-vcf/) and [API](https://opendata.clermont-ferrand.fr/api/explore/v2.1/catalog/datasets/marches-publics-a-partir-de-2020-vcf/records) | Available and annually updated; targeted query verified 29 July 2026 | Authoritative with limitation for the contract metadata the City publishes; relevant records include a 2020 schoolyard-regreening study and 2025-labelled design and user-assistance services | Discovery only; no bounded response has been retained or admitted to the pilot snapshot; record completeness and amount tax basis require review |
| `src-boamp-schoolyard-regreening-2025` | BOAMP [competition notice `25-110034`](https://www.boamp.fr/pages/avis/?q=idweb:25-110034) and [award notice `26-4348`](https://www.boamp.fr/pages/avis/?q=idweb:26-4348) | Official records linked by contract-folder identifier; competition published 5 October 2025, award decision dated 26 November 2025, award notice published 15 January 2026 | Authoritative with limitation for the reported procurement procedure, lot scopes, awardees, dates, and values | Discovery only; the post-cut-off publication and January 2026 contract issue dates MUST remain explicit; no link to the already reported 2023 Pierre-et-Marie-Curie maternal delivery is established |
...
| Procurement | The City procurement dataset reports a €45,750 schoolyard-regreening study notified in 2020. BOAMP records a 2025 design and user-assistance competition for four school groups and two awards; these discoveries are not yet part of the executable evidence bundle | No works contract has been mapped to the reported Nestor-Perret or Pierre-et-Marie-Curie maternal delivery. The 2025 services records do not establish expenditure, works completion, or continuity with the 2023 Pierre site |
...
| P1 | Admission of the newly located procurement records | The City dataset reports contract `20202012301`; BOAMP links notices `25-110034` and `26-4348` and contracts `25-119` and `25-120` | Acquire bounded official responses, record fingerprints and source versions, complete rights/security review, then add source profiles and executable evidence without silently changing the 2025 snapshot |
...
## Research update — 29 July 2026

The following findings refine the acquisition plan but do not yet alter the executable pilot snapshot:
...
2. Adopted policy, programme authorization, programme expenditure, limited site evidence, and procurement leads are mapped. The newly located procurement records are not yet admitted to the executable bundle; attributable works procurement, transaction-level or school-level accounting, and competent completion records remain missing.

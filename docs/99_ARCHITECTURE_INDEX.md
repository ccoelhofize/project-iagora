...
| [`rfc/RFC-0001-portable-governed-source-acquisition.md`](rfc/RFC-0001-portable-governed-source-acquisition.md) | Draft, Increments 0–2 implemented | Portable local and manually triggered GitHub Actions acquisition, human admission, and deferred external storage; remote acquisition is unexercised and admission remains absent |
...
| [`../src/iagora/`](../src/iagora/) | Bounded portable prototype | Deterministic validation and product projection plus one registered Opendatasoft connector, constrained HTTPS transport, replay, structural validation, append-only quarantine, temporary remote packaging, safe issue receipts, and deterministic receipt transitions; no admission path |
| [`../tests/`](../tests/) | Executable tests | Contract, evidence, scope, replay, publication, accessibility, SSRF, redirect, quarantine, deduplication, local-runner equivalence, package, receipt, expiry, and workflow guardrails; acquisition tests use retained or injected responses |
...
| [`../.github/workflows/governed-acquisition.yml`](../.github/workflows/governed-acquisition.yml) | Implemented, unexercised | Manual one-plan acquisition, read-only checkout, 14-day package, and separately privileged metadata-only receipt issue |
